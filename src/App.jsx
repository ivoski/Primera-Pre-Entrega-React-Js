  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={<ItemListContainer products={products} setProducts={setProducts}/>}/>
        <Route path="/:categoryName" element={<ItemListContainer products={products} setProducts={setProducts}/>}/>
      </Routes>
    </>
  );
}
